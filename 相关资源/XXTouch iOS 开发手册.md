...
- ### 多点色偏模式找色 (**screen\.find\_color**)
    ...
    - 说明
        ...
        |0x67 \- 0x34 = 0x33|0x45 \+ 0x12 = 0x9B|
        |0x89 \- 0x56 = 0x33|0x45 \+ 0x12 = 0xDF|
...
- ### 屏幕找图 (**screen\.find\_image**)
    ...
    - 示例
        [XXT 取色器 1.0.13 Windows 版.7z](https://github.com/havonz/XXTouchDebs/blob/master/%E7%9B%B8%E5%85%B3%E8%B5%84%E6%BA%90/XXT%20%E5%8F%96%E8%89%B2%E5%99%A8%201.0.13%20Windows%20%E7%89%88.7z)
        ```lua
...
- ### tesseract \- 对图片进行 ocr 识别 (**:tess\_ocr**)
    ...
    - 说明
        ...
        > 这里提供适用于 XXTouch 的 tesseract 引擎版本为 3\.05 版的 OCR 识别库 [tess_ocr_1.2_with_tesseract_3.05.01.zip-1853.9kB（点击下载）][3]
        > 白名单参数和黑名单参数不可同时存在
        > 会对对象本身产生影响
        > 性能上，该函数操作过程不产生数据拷贝
        > 如果需要做简体中文或是其它语言文字识别
...
### webview 使用示例
- 更多示例脚本下载
    [\[演示\]WV高阶UI-自制toast.lua-1.9kB][4]
    [\[实例\]WV高阶UI-修改GPS位置.lua-3.8kB][5]
...
- Windows 平台工具
    ...
    > - [XXT 取色器 1.0.13 Windows 版.zip](https://github.com/havonz/XXTouchDebs/blob/master/%E7%9B%B8%E5%85%B3%E8%B5%84%E6%BA%90/XXT%20%E5%8F%96%E8%89%B2%E5%99%A8%201.0.13%20Windows%20%E7%89%88.7z)  
